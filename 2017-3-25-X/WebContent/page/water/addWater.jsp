					...
					<form action="../../index3.jsp" method="post">
						...
						<div id="inputjobfair">
								...
								<p style="text-align:center">
									<input type="submit" value="提交" id="submitid" onclick="alert('确认提交')";return true;/>
		...
		<%--  <script type="text/javascript">
			...
			var isExist=false;
					...
					if(data=="true"){
							$("p").hide();
							$("#showerr").show();
							$("#erreinfo").html("添加成功<a href='<%=path %>/page/water/addWater.jsp'> 返回继续</a>");
						}else{
							$("#showerr").show();
							$("#erreinfo").html("对不起本月用户已添加<a href='<%=path %>/page/water/addWater.jsp'> 返回继续</a>");
						}
