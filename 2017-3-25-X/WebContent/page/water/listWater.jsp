...
<!-- Reset Stylesheet -->
<link rel="stylesheet"
	href="<%=path%>/page/admin/resources/css/reset.css" type="text/css"
	media="screen" />

<!-- Main Stylesheet -->
<link rel="stylesheet"
	href="<%=path%>/page/admin/resources/css/main.css" type="text/css"
	media="screen" />

<!-- Invalid Stylesheet. This makes stuff look pretty. Remove it if you want the CSS completely valid -->
<link rel="stylesheet"
	href="<%=path%>/page/admin/resources/css/invalid.css" type="text/css"
	media="screen" />
...
<script type="text/javascript"
	src="<%=path%>/page/admin/resources/scripts/jquery-1.3.2.min.js"></script>

<!-- jQuery Configuration -->
<script type="text/javascript"
	src="<%=path%>/page/admin/resources/scripts/simpla.jquery.configuration.js"></script>

<!-- Facebox jQuery Plugin -->
<script type="text/javascript"
	src="<%=path%>/page/admin/resources/scripts/facebox.js"></script>

<!-- jQuery WYSIWYG Plugin -->
<script type="text/javascript"
	src="<%=path%>/page/admin/resources/scripts/jquery.wysiwyg.js"></script>
		...
		<div id="main-content">
			...
			<div class="content-box">
				...
				<div class="content-box-header">
					...
					<div style="float: left; margin: 0 px; height: 20px; padding: 0 px">
						<form method="post" action="#">
							<p>
								<label>寝室编号: <input name="uids" type=text id="userid" />
					...
					<div style="text-align: right">
						<%-- <a href="<%=path %>/exportWaterInfo.do">导出excel</a> --%>
						&nbsp;&nbsp;
						<c:if test="${usertype==0 }">
							<a id="add"
								href="<%=path %>/page/water/addWater.jsp?moneyid=${money.id}">添加水费信息</a>
						</c:if>
					...
					<div class="tab-content default-tab" id="tab1">
						...
						<table width="100%">
							...
							<tr>
								...
								<td>4</td>
								<td>1元/吨</td>
                              <td> <input class = "click"type="submit" value="缴费"></td>
				...
				<div class="pagestyle">
					...
					[<a
						href="<%=path %>/listUser.do?currentPage=${pager.currentPage}&pagerMethod=first">首页</a>]
					[<a
						href="<%=path %>/listUser.do?currentPage=${pager.currentPage}&pagerMethod=previous">前一页</a>]
					共[ ${pager.currentPage}/<b>${pager.totalPages }25</b>]页 [<a
						href="<%=path %>/listUser.do?currentPage=${pager.currentPage}&pagerMethod=next">下一页</a>]
					[<a
						href="<%=path %>/listUser.do?currentPage=${pager.currentPage}&pagerMethod=last">末页</a>]
				</div>
				<div class="clear"></div>
			</div>
			<!-- End .content-box -->
